...
class User(AbstractBaseUser):
	""" User objects with summoner name. """
	...
	summoner_name = models.CharField(max_length=50, unique=True)
	...
	USERNAME_FIELD = 'summoner_name'
	REQUIRED_FIELDS = ['summoner_name']
	objects = UserObjectManager()

	def __unicode__(self):
		return u"{}".format(self.summoner_name)
